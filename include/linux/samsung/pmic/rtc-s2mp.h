...
#if IS_ENABLED(CONFIG_RTC_DRV_S2MPS27)
#define S2MP_RTC_REG_SECURE_CNT1	0x1B
#define S2MP_RTC_REG_SECURE_CNT2	0x1C
#define S2MP_RTC_REG_SECURE_CNT3	0x1D
#define S2MP_RTC_REG_SECURE_CNT4	0x1E
#define S2MP_RTC_REG_SECURE1	(0x23)
#define S2MP_RTC_REG_SECURE2	(0x24)
#define S2MP_RTC_REG_SECURE3	(0x25)
#define S2MP_RTC_REG_SECURE4	(0x26)
#define S2MP_RTC_REG_WDT	(0x27)
#else
