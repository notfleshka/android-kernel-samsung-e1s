...
extern u32 acpm_get_apsoc_dsupd_count(void);
extern u32 acpm_get_apsoc_dsupd_early_wakeup_count(void);
extern u32 acpm_get_apsoc_sicd_early_wakeup_count(void);
extern u32 acpm_get_apsoc_sleep_early_wakeup_count(void);
extern u32 acpm_get_apsoc_count(void);
extern u32 acpm_get_apsicd_count(void);
extern u32 acpm_get_apsleep_count(void);
extern u32 acpm_get_mifdn_count(void);
extern u32 acpm_get_mifdn_sicd_count(void);
extern u32 acpm_get_mifdn_sleep_count(void);
...
extern void exynos_flexpmu_dbg_mif_req(bool start);
#else
extern void exynos_flexpmu_dbg_mif_req(void);
#endif
extern void acpm_print_mif_request(void);
#else
static inline u32 acpm_get_apsoc_dsupd_count(void) { return 0; }
static inline u32 acpm_get_apsoc_dsupd_early_wakeup_count(void) { return 0; }
static inline u32 acpm_get_apsoc_sicd_early_wakeup_count(void) { return 0; }
static inline u32 acpm_get_apsoc_sleep_early_wakeup_count(void) { return 0; }
static inline u32 acpm_get_apsoc_count(void) { return 0; }
static inline u32 acpm_get_apsicd_count(void) { return 0; }
static inline u32 acpm_get_apsleep_count(void) { return 0; }
static inline u32 acpm_get_mifdn_count(void) { return 0; }
static inline u32 acpm_get_mifdn_sicd_count(void) { return 0; }
static inline u32 acpm_get_mifdn_sleep_count(void) { return 0; }
