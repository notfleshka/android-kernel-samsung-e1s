...
static struct gpio_dvs_t s5e9945_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.skip_grps = "gpf0 gpv0", /* HSI1 DMIC(VTS) */
};

const struct secgpio_dvs_data s5e9945_secgpio_dvs_data = {
	.gpio_dvs = &s5e9945_secgpio_dvs,
	.get_nr_gpio = samsung_pinctrl_get_nr_gpio,
};
EXPORT_SYMBOL_GPL(s5e9945_secgpio_dvs_data);
#endif /* CONFIG_PINCTRL_SEC_GPIO_DVS */
