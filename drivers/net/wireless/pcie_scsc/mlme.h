...
#define SLSI_SCAN_DONE_IND_WAIT_TIMEOUT 20000 /* 20 seconds */
...
#endif
#define SLSI_MLME_TYPE_COEX 0x10
...
#endif
#define SLSI_MLME_SUBTYPE_COEX_CP_INFO 0x00
...
struct slsi_sar_max_tx_power {
	u8 antenna1non_dbs_power_limit;
	u8 antenna2non_dbs_power_limit;
	u8 antenna1dbs_power_limit;
	u8 antenna2dbs_power_limit;
	u8 antenna1last_tx_power;
	u8 antenna2last_tx_power;
	u8 antenna1average_tx_power;
	u8 antenna2average_tx_power;
};
