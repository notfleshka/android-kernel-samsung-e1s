...
#define SLSI_OVERRIDE_TIMEOUT_IN_MS 1000

#ifdef CONFIG_SCSC_WLAN_NAPI_PER_NETDEV
enum netif_napi_reason {
	NETIF_NAPI_REASON_LATENCY,
	NETIF_NAPI_REASON_TPUT
};
#endif
