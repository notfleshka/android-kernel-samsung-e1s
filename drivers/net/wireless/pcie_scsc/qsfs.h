...
#define DUAL_BAND_CONCURRENCY_WITH_6G 2
#define DUAL_BAND_CONCURRENCY 1
...
/* Increment this version if any change in feature set */
#define SLSI_QSF_WIFI_FEATURE_VERSION 4
