...
#define slsi_configure_pmksa(args...)				        kunit_mock_slsi_configure_pmksa(args)
...
static int kunit_mock_slsi_get_beacon_cu(struct slsi_dev *sdev, struct net_device *dev, int *mib_value, u16 vif_idx)
{
	return 0;
}
...
static void kunit_mock_slsi_roam_channel_cache_prune(struct net_device *dev, int seconds, char *ssid, int ssid_len)
{
	return;
}
...
static int kunit_mock_slsi_configure_pmksa(struct slsi_dev *sdev, struct net_device *dev, struct slsi_peer *peer)
{
	return 0;
}
#endif
