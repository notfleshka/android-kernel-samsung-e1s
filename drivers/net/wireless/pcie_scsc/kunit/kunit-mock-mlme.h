...
static int kunit_mock_slsi_mlme_set_max_bw(struct slsi_dev *sdev, struct net_device *dev, u8 link_id,
...
static int kunit_mock_slsi_mlme_set_with_vifnum(struct slsi_dev *sdev, struct net_device *dev, u8 *mib,
						int mib_len, u16 vifnum)
{
	return 0;
}

static int kunit_mock_slsi_mlme_set_scan_timing_req(struct slsi_dev *sdev, struct net_device *dev, u16 scan_mode,
						    u16 max_channel_time, u16 home_away_time, u16 home_time,
						    u16 max_channel_passive_time)
{
	return 0;
}

static int kunit_mock_slsi_mlme_sar_get_avg_tx_power(struct slsi_dev *sdev, struct net_device *dev, u8 dsi_id,
						     u8 report_mode, struct slsi_sar_avg_tx_power *avg_tx_pwr)
{
	return 0;
}

static int kunit_mock_slsi_mlme_sar_get_tx_power_limit(struct slsi_dev *sdev, struct net_device *dev, u16 op_class,
						       u8 dsi_id, struct slsi_mlme_sar_tx_power_limit *limits)
{
	return 0;
}
...
static int kunit_mock_slsi_mlme_set_low_latency_mode_req(struct slsi_dev *sdev, struct net_device *dev,
							 u16 latency_mode)
{
	return 0;
}

static int slsi_mlme_get_with_vifidx(struct slsi_dev *sdev, struct net_device *dev, u8 *mib, int mib_len,
