...
#if defined(CONFIG_SCSC_BB_REDWOOD)
	void (*set_l1ss_ctrl)(struct scsc_mif_abs *interface, u32 val);
#endif
#endif
...
#define S620	1
	...
	void (*set_pcie_cb_panic)(struct scsc_mif_abs *interface, bool val);
	void (*set_link_fail_panic)(struct scsc_mif_abs *interface, bool val);
#endif
#if defined(CONFIG_SCSC_BB_REDWOOD)
