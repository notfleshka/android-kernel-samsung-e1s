...
#include "is-dt.h"
#include "is-cis-3lu-dphy.h"
#include "is-cis-3lu-dphy-setA-19p2.h"
...
void sensor_3lu_cis_set_mode_group(u32 mode)
{
	...
	case SENSOR_3LU_4000X2252_60FPS_10BIT:
		sensor_3lu_mode_groups[SENSOR_3LU_MODE_AEB] = SENSOR_3LU_4000X2252_60FPS_10BIT_AEB;
		sensor_3lu_mode_groups[SENSOR_3LU_MODE_LN2] = SENSOR_3LU_4000X2252_30FPS_10BIT_LN2;
		break;
	case SENSOR_3LU_4000X3000_60FPS_10BIT:
	case SENSOR_3LU_4000X3000_60FPS_10BIT_AEB:
	case SENSOR_3LU_4000X3000_15FPS_10BIT_LN4:
		sensor_3lu_mode_groups[SENSOR_3LU_MODE_AEB] = SENSOR_3LU_4000X3000_60FPS_10BIT_AEB;
...
int sensor_3lu_cis_stream_on(struct v4l2_subdev *subdev)
{
	...
	/* 3lu dphy should turn on emb for image quality issues */
	if (device->pdata->use_cphy) {
		info("%s - use cphy & turn off emb\n", __func__);
	...
	const struct i2c_device_id *id)
{
	...
	if (mclk_freq_khz == 19200) {
		if (strcmp(setfile, "default") == 0 || strcmp(setfile, "setA") == 0)
			probe_info("%s dphy setfile_A mclk: 19.2MHz\n", __func__);
		else
			err("setfile index out of bound, take default (dphy setfile_A mclk: 19.2MHz)");
...
static const struct of_device_id sensor_cis_3lu_match[] = {
	{
		.compatible = "samsung,exynos-is-cis-3lu-dphy",
	},
	{},
};
