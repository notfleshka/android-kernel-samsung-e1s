...
#ifdef CONFIG_USE_VENDOR_FEATURE
...
static int sensor_zc533_write_position(struct i2c_client *client, u32 val)
{
	...
	ret = actuator->ixc_ops->addr_data_write16(client, REG_POSITION_MSB, val_high, val_low);
	if (ret < 0)
		goto p_err;
...
static int sensor_zc533_actuator_probe_i2c(struct i2c_client *client,
...
static struct i2c_driver sensor_actuator_zc533_driver = {
	.probe  = sensor_zc533_actuator_probe_i2c,
	.driver = {
		.name	= ACTUATOR_NAME,
		.owner	= THIS_MODULE,
