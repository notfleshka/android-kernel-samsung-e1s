...
static const struct cstat_hw_dma cstat_dmas[CSTAT_DMA_NUM] = {
	...
	{CSTAT_W_FDPIG,		CSTAT_R_YUV_WDMAFDPIG_EN,	"W_FDPIG"},
	{CSTAT_W_SAT,		CSTAT_R_YUV_WDMASAT_EN,		"W_SAT"},
	{CSTAT_W_CAV,		CSTAT_R_YUV_WDMACAV_EN,		"W_CAV"},
};
...
static void _cstat_hw_s_ds_fdpig(void __iomem *base, bool en, struct cstat_ds_cfg *cfg)
{
	...
	if (!en) {
		...
		val = 0;
		val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_BYPASS, 1);
		val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_ENABLE, 0);
	...
	/* Crop configuration */
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_CROP_START_X, cfg->in_crop.x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_CROP_START_Y, cfg->in_crop.y);
	CSTAT_SET_R(base, CSTAT_R_RGB_FDPIGDS_CROP_START, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_CROP_SIZE_X, cfg->in_crop.w);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_CROP_SIZE_Y, cfg->in_crop.h);
	...
	/* Scale configuration */
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_OUTPUT_W, cfg->ot_crop.w);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_OUTPUT_H, cfg->ot_crop.h);
	...
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_INV_SCALE_X, cfg->inv_scale_x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_INV_SCALE_Y, cfg->inv_scale_y);
	CSTAT_SET_R(base, CSTAT_R_RGB_FDPIGDS_INV_SCALE, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_INV_SHIFT_X, cfg->inv_shift_x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_INV_SHIFT_Y, cfg->inv_shift_y);
	CSTAT_SET_R(base, CSTAT_R_RGB_FDPIGDS_INV_SHIFT, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_BYPASS, 0);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_FDPIGDS_ENABLE, 1);
	CSTAT_SET_R(base, CSTAT_R_RGB_FDPIGDS_BYPASS, val);
}
...
static void _cstat_hw_s_ds_sat(void __iomem *base, bool en, struct cstat_ds_cfg *cfg)
{
	...
	if (!en) {
		...
		val = 0;
		val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_BYPASS, 1);
		val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_ENABLE, 0);
	...
	/* Crop configuration */
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_CROP_START_X, cfg->in_crop.x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_CROP_START_Y, cfg->in_crop.y);
	CSTAT_SET_R(base, CSTAT_R_RGB_SATDS_CROP_START, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_CROP_SIZE_X, cfg->in_crop.w);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_CROP_SIZE_Y, cfg->in_crop.h);
	...
	/* Scale configuration */
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_OUTPUT_W, cfg->ot_crop.w);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_OUTPUT_H, cfg->ot_crop.h);
	...
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_INV_SCALE_X, cfg->inv_scale_x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_INV_SCALE_Y, cfg->inv_scale_y);
	CSTAT_SET_R(base, CSTAT_R_RGB_SATDS_INV_SCALE, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_INV_SHIFT_X, cfg->inv_shift_x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_INV_SHIFT_Y, cfg->inv_shift_y);
	CSTAT_SET_R(base, CSTAT_R_RGB_SATDS_INV_SHIFT, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_BYPASS, 0);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_SATDS_ENABLE, 1);
	CSTAT_SET_R(base, CSTAT_R_RGB_SATDS_BYPASS, val);
}
...
static void _cstat_hw_s_ds_cav(void __iomem *base, bool en, struct cstat_ds_cfg *cfg)
{
	...
	if (!en) {
		...
		val = 0;
		val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_BYPASS, 1);
		val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_ENABLE, 0);
	...
	/* Crop configuration */
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_CROP_START_X, cfg->in_crop.x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_CROP_START_Y, cfg->in_crop.y);
	CSTAT_SET_R(base, CSTAT_R_RGB_CAVDS_CROP_START, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_CROP_SIZE_X, cfg->in_crop.w);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_CROP_SIZE_Y, cfg->in_crop.h);
	...
	/* Scale configuration */
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_OUTPUT_W, cfg->ot_crop.w);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_OUTPUT_H, cfg->ot_crop.h);
	...
	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_INV_SCALE_X, cfg->inv_scale_x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_INV_SCALE_Y, cfg->inv_scale_y);
	CSTAT_SET_R(base, CSTAT_R_RGB_CAVDS_INV_SCALE, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_INV_SHIFT_X, cfg->inv_shift_x);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_INV_SHIFT_Y, cfg->inv_shift_y);
	CSTAT_SET_R(base, CSTAT_R_RGB_CAVDS_INV_SHIFT, val);

	val = 0;
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_BYPASS, 0);
	val = CSTAT_SET_V(val, CSTAT_F_RGB_CAVDS_ENABLE, 1);
	CSTAT_SET_R(base, CSTAT_R_RGB_CAVDS_BYPASS, val);
}

static void _cstat_hw_s_conv(void __iomem *base, enum is_hw_cstat_reg_name reg_name, bool en)
{
	CSTAT_SET_R(base, reg_name, !en);
}
...
int cstat_hw_s_reset(void __iomem *base)
{
	...
	for (dma_id = CSTAT_RDMA_NUM; dma_id < CSTAT_DMA_NUM; dma_id++) {
		if (cstat_dmas[dma_id].dma_id == CSTAT_DMA_NONE)
			continue;

		dma_base = base + cstat_regs[cstat_dmas[dma_id].reg_id].sfr_offset;

		writel(0x3, dma_base + 0x1E4);
		writel(0x3, dma_base + CSTAT_COREX_SDW_OFFSET + 0x1E4);
	}
...
void cstat_hw_s_crc_seed(void __iomem *base, u32 seed)
{
	...
	CSTAT_SET_F(base, CSTAT_R_RGB_FDPIGDS_CRC, CSTAT_F_RGB_FDPIGDS_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_RGB_RGBTOYUVFDPIG_STREAM_CRC, CSTAT_F_RGB_RGBTOYUVFDPIG_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_YUV_YUV444TO422FDPIG_STREAM_CRC, CSTAT_F_YUV_YUV444TO422FDPIG_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_YUV_YUV422TO420FDPIG_STREAM_CRC, CSTAT_F_YUV_YUV422TO420FDPIG_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_RGB_SATDS_CRC, CSTAT_F_RGB_SATDS_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_RGB_RGBTOYUVSAT_STREAM_CRC, CSTAT_F_RGB_RGBTOYUVSAT_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_YUV_YUV444TO422SAT_STREAM_CRC, CSTAT_F_YUV_YUV444TO422SAT_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_YUV_YUV422TO420SAT_STREAM_CRC, CSTAT_F_YUV_YUV422TO420SAT_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_RGB_CAVDS_CRC, CSTAT_F_RGB_CAVDS_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_RGB_RGBTOYUVCAV_STREAM_CRC, CSTAT_F_RGB_RGBTOYUVCAV_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_YUV_YUV444TO422CAV_STREAM_CRC, CSTAT_F_YUV_YUV444TO422CAV_CRC_SEED, seed);
	CSTAT_SET_F(base, CSTAT_R_YUV_YUV422TO420CAV_STREAM_CRC, CSTAT_F_YUV_YUV422TO420CAV_CRC_SEED, seed);
...
void cstat_hw_s_simple_lic_cfg(void __iomem *base, struct cstat_simple_lic_cfg *cfg)
{
	...
	val = CSTAT_SET_V(val, CSTAT_F_LIC_FAKE_GEN_ON, 0);
