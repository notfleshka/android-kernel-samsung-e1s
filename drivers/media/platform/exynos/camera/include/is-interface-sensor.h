...
typedef struct {
	...
	struct is_sensor_seamless_ctl seamless_mode_history[NUM_FRAMES];
} cis_shared_data;
...
struct is_cis_ops {
	...
	int (*cis_set_totalgain)(struct v4l2_subdev *subdev,
	...
	int (*cis_update_seamless_state)(struct v4l2_subdev *subdev);
...
struct is_ois_ops {
	...
	void (*ois_mgless)(struct is_core *core);
