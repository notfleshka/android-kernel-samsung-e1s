...
u64 early_module_core_size = 0;
u64 early_module_init_text = 0;
u64 early_module_init_size = 0;
...
{
	struct module_info early_module_info;

	uh_call(UH_APP_RKP, RKP_DEFERRED_START, 0, 0, 0, 0);

	early_module_info.base_va = 0;
	early_module_info.vm_size = 0;
	early_module_info.core_base_va = early_module_core_text;
	early_module_info.core_text_size = early_module_core_size;
	early_module_info.core_ro_size = 0;
	early_module_info.init_base_va = 0;
	early_module_info.init_text_size = 0;
	//early_module_info.init_base_va = early_module_init_text;
	//early_module_info.init_text_size = early_module_init_size;
	uh_call(UH_APP_RKP, RKP_MODULE_LOAD, RKP_MODULE_PXN_CLEAR, (u64)&early_module_info, 0, 0);
}
...
void rkp_robuffer_init(void)
{
	...
	printk("robuffer_base: %llx, robuffser_size: %llx\n", robuffer_base, robuffer_size);
}
