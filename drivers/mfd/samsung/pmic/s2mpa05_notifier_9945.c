...
static const uint8_t s2mpa05_get_irq_mask[] = {
	/* OI */
	[S2MPA05_IRQ_OI_B1E] = S2MPA05_PMIC_IRQ_OI_B1_MASK,
	[S2MPA05_IRQ_OI_B2E] = S2MPA05_PMIC_IRQ_OI_B2_MASK,
	[S2MPA05_IRQ_OI_B3E] = S2MPA05_PMIC_IRQ_OI_B3_MASK,
	[S2MPA05_IRQ_OI_B4E] = S2MPA05_PMIC_IRQ_OI_B4_MASK,
	/* OCP */
	[S2MPA05_IRQ_OCP_B1E] = S2MPA05_PMIC_IRQ_OCP_B1_MASK,
	[S2MPA05_IRQ_OCP_B2E] = S2MPA05_PMIC_IRQ_OCP_B2_MASK,
	[S2MPA05_IRQ_OCP_B3E] = S2MPA05_PMIC_IRQ_OCP_B3_MASK,
	[S2MPA05_IRQ_OCP_B4E] = S2MPA05_PMIC_IRQ_OCP_B4_MASK,
	/* Temp */
...
static void s2mpa05_irq_work_func(struct work_struct *work)
{
	...
	pr_info("[PMIC] %s: s2mpa05 pmic interrupt %s\n", __func__, buf);
}

static int s2mpa05_enable_irq(struct s2mpa05_dev *s2mpa05, const bool en)
{
	return s2mpa05_update_reg(s2mpa05->com, S2MPA05_COMMON_TX_MASK,
			(en) ? 0 : 0x1, 0x1);
}
